...
class Xapi {
    ...
    //构造函数
    constructor(args, mysqlPool, app, sqliteDB, memoryDB, sqlite3DB) {
        this.config = args;
        this.mysql = new Xsql(args, mysqlPool, sqliteDB, memoryDB, sqlite3DB);
        this.app = app;
        this.ctrls = [];
    ...
    setupRoutes() {
        ...
        for (var j = 0; j < resources.length; ++j) {
            ...
            let resourceCtrl = new Xctrl(this.app, this.mysql, this.sqliteDB, this.memoryDB, this.sqlite3DB);
