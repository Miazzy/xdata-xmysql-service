                    ...
                    case "bulkInsert":
                        if (!this.config.readOnly) {
                            this.app
                                .route(routes[i]["routeUrl"])
                                .post(
                                    this.asyncMiddleware(resourceCtrl.bulkInsert.bind(resourceCtrl))
                                );
                        }
                        break;
                    ...
                    case "multiInsert":
                        if (!this.config.readOnly) {
                            this.app
                                ...
                                .delete(
                                    injMiddleware,
                                    this.asyncMiddleware(resourceCtrl.multiInsert.bind(resourceCtrl))
                                );
                        }
                        break;
                    ...
                    case "whereDeleteAndInsert":
                        if (!this.config.readOnly) {
                            this.app
                                ...
                                .delete(
                                    injMiddleware,
                                    this.asyncMiddleware(resourceCtrl.whereDeleteAndInsert.bind(resourceCtrl))
                                );
                        }
                        break;
                    ...
                    case "whereDelete":
                        if (!this.config.readOnly) {
                            this.app
                                ...
                                .delete(
                                    injMiddleware,
                                    this.asyncMiddleware(resourceCtrl.whereDelete.bind(resourceCtrl))
                                );
                        }
                        break;
                    ...
                    case "bulkDelete":
                        if (!this.config.readOnly) {
                            this.app
                                ...
                                .delete(
                                    injMiddleware,
                                    this.asyncMiddleware(resourceCtrl.bulkDelete.bind(resourceCtrl))
                                );
                        }
                        break;
