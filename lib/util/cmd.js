...
console.log(`config:`, config, ` serviceConfig:`, serviceConfig);
...
exports.handle = program => {
    ...
    program.database = program.database || serviceConfig.database || "localhost";
    ...
    const { database, host, user } = program;
    console.log(`String server by program config :`, { database, host, user });
