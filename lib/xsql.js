...
class Xsql {
    ...
    //合并执行
    mergeExec(query = '', params = [], callback = () => {}) {
    ...
    //本地数据库并发执行
    parallelExec(query = '', params = [], callback = () => {}) {
        try {
