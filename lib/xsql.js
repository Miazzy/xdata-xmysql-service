...
class Xsql {
    ...
    exec(query, params) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            (async() => { //异步日志记录到MySQL中
                _this.pool.query(`INSERT INTO bs_sql_log (id, statement, params, execstr) VALUES (?, ?, ?, ?);`, [tools.queryUniqueID(), query, JSON.stringify(params), sqlstring.format(query, params)]);
            })();
            (async() => { //异步日志记录到消息队列中
