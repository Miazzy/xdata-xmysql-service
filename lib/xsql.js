...
class Xsql {
    ...
    mergeExec(tableName = '', query = '', params = [], callback = () => {}) {
        this.parallelExec(query, params, callback);
        this.nacosShareExec(query, params, callback);
        this.slaveDBExec(query, params, callback);
        this.mqueueExec(query, params, callback);
    }
