                                ...
                                await (async() => {
                                    ...
                                    while (page <= maxPage) {
                                        try {
                                            ...
                                            sqlite3DB.exec(execstr).catch((error) => { console.log(`sync_exec_sql_error>`, error) }); // console.log(`cur rows:`, JSON.stringify(curRows).slice(0, 100), ` page :`, page); //console.log(`statement execstr:`, execstr.slice(0, 100), ` exec success... page: `, page);
                                        } catch (error) {
